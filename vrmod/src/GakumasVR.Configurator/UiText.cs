...
internal static class UiText
{
    ...
    private static Dictionary<string, string> Korean() => new()
    {
        ...
        ["LiveSixDof"] = "라이브 6DoF",
        ["LiveSixDofEnabled"] = "사용 (실험적, 기본 꺼짐)",
        ["VfxMode"] = "VFX 모드",
    ...
    private static Dictionary<string, string> English() => new()
    {
        ...
        ["LiveSixDof"] = "Live 6DoF",
        ["LiveSixDofEnabled"] = "Enable (experimental, off by default)",
        ["VfxMode"] = "VFX mode",
        ...
        ["ErrorPrefix"] = "Error: {0}",
        ["SelectGameFolder"] = "Select the folder containing gakumas.exe.",
        ...
        ["GameExeMissing"] = "gakumas.exe was not found in the selected folder.",
    ...
    private static Dictionary<string, string> Japanese() => new()
    {
        ...
        ["LiveSixDof"] = "ライブ6DoF",
        ["LiveSixDofEnabled"] = "使用（実験的・デフォルトOFF）",
        ["VfxMode"] = "VFXモード",
