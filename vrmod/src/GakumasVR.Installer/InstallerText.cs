...
internal static class InstallerText
{
    ...
    {
        ["AppTitle"] = "Gakumas VR 설치 프로그램",
        ["Heading"] = "Gakumas VR 설치 및 관리",
        ...
        ["LocalifyAbsent"] = "설치되지 않음 — 새로 만들지 않음",
        ["Install"] = "설치",
        ["Update"] = "업데이트",
        ["Reinstall"] = "다시 설치",
        ["Uninstall"] = "제거",
        ...
        ["GameRootInvalid"] = "gakumas.exe, GameAssembly.dll, UnityPlayer.dll이 있는 폴더를 선택하세요.",
    ...
    {
        ["AppTitle"] = "Gakumas VR Installer",
        ["Heading"] = "Install and manage Gakumas VR",
        ...
        ["LocalifyAbsent"] = "Not installed — nothing will be created",
        ["Install"] = "Install",
        ["Update"] = "Update",
        ["Reinstall"] = "Reinstall",
        ["Uninstall"] = "Uninstall",
        ...
        ["ConfirmTitle"] = "Confirm Gakumas VR action",
        ...
        ["GameRootInvalid"] = "Select the folder containing gakumas.exe, GameAssembly.dll and UnityPlayer.dll.",
    ...
    {
        ["AppTitle"] = "Gakumas VR インストーラー",
        ["Heading"] = "Gakumas VR のインストールと管理",
        ...
        ["LocalifyAbsent"] = "未インストール — 新規作成しません",
        ["Install"] = "インストール",
        ["Update"] = "アップデート",
        ["Reinstall"] = "再インストール",
        ["Uninstall"] = "アンインストール",
        ...
        ["GameRootInvalid"] = "gakumas.exe、GameAssembly.dll、UnityPlayer.dllがあるフォルダーを選択してください。",
