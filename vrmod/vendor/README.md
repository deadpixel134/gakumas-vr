...
v0.164.0 패키지는 staging의 Dobby를 `BepInEx/core/dobby.dll`에 포함하고 Apache-2.0 전문을 함께 배포합니다. 빌드 시 고정 SHA-256을 확인하며, 설치기는 기존 Localify/BepInEx가 같은 경로의 파일을 제공하면 이를 보존하고 없는 경우에만 패키지 파일을 설치합니다.
