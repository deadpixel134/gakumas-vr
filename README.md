...
현재 공개 버전은 **v0.175.6 정식 릴리스**입니다. 핵심 6DoF 조작은 v0.173에서 실기 검증되었고, v0.175.6는 그 동작을 유지하면서 공간/스케일 프로필, 설정 GUI, 설치 검증과 배포 기준을 정리한 현재 공식 버전입니다. SteamVR OpenXR와 Meta Quest Link는 예비 지원 대상으로 남아 있으며, 아직 이 프로젝트에서 실기 검증하지 않았습니다.
