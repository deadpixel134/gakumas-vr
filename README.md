...
현재 공개 버전은 **v0.173.0 정식 릴리스**입니다. Meta Quest 2 + Virtual Desktop OpenXR에서 개발·검증했습니다. SteamVR OpenXR와 Meta Quest Link는 규격상 사용 가능한 예비 지원 대상으로, 아직 이 프로젝트에서 실기 검증하지 않았습니다.
...
- 오른손 3D 이동, 왼손 월드축 시야 회전과 15° 기본 스냅 턴
...
- 필요한 Dobby를 배포 ZIP에 포함합니다. v0.173.0 설치기는 게임 파일을 건드리기 전에 전체 payload와 클린 설치 필수 구성의 해시·보존 정책을 사전 검증합니다.
