...
現在の公開版は **v0.164.0プレリリース**です。Meta Quest 2＋Virtual Desktop OpenXRで開発・実機確認しています。SteamVR OpenXRとMeta Quest Linkは予備対応であり、本プロジェクトではまだ実機確認していません。
...
- 配布ZIPには必要なDobbyが含まれます。v0.164.0インストーラーはゲームフォルダーへ書き込む前に、payload全体のハッシュ、クリーンインストール必須構成、保持ポリシーを事前検証します。
