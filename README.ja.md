...
現在の公開版は **v0.173.0正式リリース**です。Meta Quest 2＋Virtual Desktop OpenXRで開発・実機確認しています。SteamVR OpenXRとMeta Quest Linkは予備対応であり、本プロジェクトではまだ実機確認していません。
...
- 右手3D移動、左手ワールド軸視点回転、デフォルト15°スナップ
...
- 配布ZIPには必要なDobbyが含まれます。v0.173.0インストーラーはゲームフォルダーへ書き込む前に、payload全体のハッシュ、クリーンインストール必須構成、保持ポリシーを事前検証します。
