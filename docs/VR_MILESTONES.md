...
현재 소스/설치본 v0.173.0, M7 설정·설치·자동 업데이트·6DoF 조작 사용자 실기 완료
...
| M8 | **진행 중 — 정식 릴리스 기준 확립** | 런타임 호환성·유지보수 | v0.173 정식 Release를 기준으로 VD 회귀를 유지하고 SteamVR/Quest Link 예비 경로, 게임 업데이트 호환성 gate와 개인정보 없는 진단 흐름을 확장 |
