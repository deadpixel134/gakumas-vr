...
현재 소스/설치본 v0.174.0, M7 사용자 실기 기준 v0.173 유지, M8 배포 기본 프로필 갱신 진행
...
| M8 | **진행 중 — 런타임 호환성·유지보수** | 배포 기본값·런타임 호환성·유지보수 | v0.174 최신 정식 Release와 v0.173 사용자 실기 기준을 구분해 유지하고 SteamVR/Quest Link 예비 경로, 게임 업데이트 호환성 gate와 개인정보 없는 진단 흐름을 확장 |
